...
class TemplateCreateInput {
  ...
  @ApiProperty({
    required: false,
    type: () => GeneratedImageCreateNestedManyWithoutTemplatesInput,
  })
  @ValidateNested()
  @Type(() => GeneratedImageCreateNestedManyWithoutTemplatesInput)
  @IsOptional()
  @Field(() => GeneratedImageCreateNestedManyWithoutTemplatesInput, {
    nullable: true,
  })
  ...
  @ApiProperty({
    required: false,
    type: () => GeneratedPageCreateNestedManyWithoutTemplatesInput,
  })
  @ValidateNested()
  @Type(() => GeneratedPageCreateNestedManyWithoutTemplatesInput)
  @IsOptional()
  @Field(() => GeneratedPageCreateNestedManyWithoutTemplatesInput, {
    nullable: true,
  })
