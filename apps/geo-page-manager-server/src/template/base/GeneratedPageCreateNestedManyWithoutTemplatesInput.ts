...
@InputType()
class GeneratedPageCreateNestedManyWithoutTemplatesInput {
...
export { GeneratedPageCreateNestedManyWithoutTemplatesInput as GeneratedPageCreateNestedManyWithoutTemplatesInput };
